...
pal_1 <- c("Saline_Veh"="#0C727C", "CFA_Veh"="#FCBF6E", "CFA_ApAP"="#90D5E4", "CFA_3DDA"="#D24B27")
...
umap_pal <- c("GABAergic Neurons" = "#4B2991","Glut Neurons" = "#FCBF6E","Oligodendrocytes"="#90D5E4", "OPCs"="#88CFA4",
